                ...
                @foreach ($products as $items)
                    <li class="one_items">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8"><h5>[{{ ucfirst($items->category) }}] <a href="{{ route('detail',$items->slug) }}" >{{ $items->name }}</a> - @foreach($items->singers as $key=>$singer) @if($key>0) , <a href="{{ route('singer.detail',$singer->slug) }}">{{ $singer->name }}</a> @else <a href="{{ route('singer.detail',$singer->slug) }}">{{ $singer->name }}</a>@endif  @endforeach</h5></div>
